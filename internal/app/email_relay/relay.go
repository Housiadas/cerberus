// Package email_relay polls the email_notification_outbox table and sends emails via SMTP.
package email_relay
...
// Relay polls in the email_notification_outbox table and sends emails.
type Relay struct {
	log            logger.Logger
