...
func (_mock *MockStorer) NewWithTx(tx pgsql.CommitRollbacker) (account.Storer, error) {
	ret := _mock.Called(tx)
	...
	var r0 account.Storer
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) (account.Storer, error)); ok {
		return returnFunc(tx)
	}
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) account.Storer); ok {
		r0 = returnFunc(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(account.Storer)
		}
	}
...
func (_c *MockStorer_NewWithTx_Call) Return(storer account.Storer, err error) *MockStorer_NewWithTx_Call {
	_c.Call.Return(storer, err)
	return _c
}

func (_c *MockStorer_NewWithTx_Call) RunAndReturn(run func(tx pgsql.CommitRollbacker) (account.Storer, error)) *MockStorer_NewWithTx_Call {
	_c.Call.Return(run)
	return _c
}
