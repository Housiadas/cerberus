...
type Service struct {
	log    logger.Logger
	storer billing_address2.Storer
}

// New constructs the service.
func New(log logger.Logger, storer billing_address2.Storer) *Service {
	return &Service{
		log:    log,
		storer: storer,
	}
...
func (s *Service) Create(ctx context.Context, addr billing_address2.BillingAddress) error {
...
func (s *Service) Update(ctx context.Context, addr billing_address2.BillingAddress) error {
...
func (s *Service) Delete(ctx context.Context, addr billing_address2.BillingAddress) error {
...
func (s *Service) QueryByID(
	...
	if err != nil {
		return billing_address2.BillingAddress{}, fmt.Errorf("query by id: %w", err)
	}
