...
func (_mock *MockStorer) Create(ctx context.Context, acct Account) error {
	ret := _mock.Called(ctx, acct)
...
//   - ctx context.Context
//   - acct Account
func (_e *MockStorer_Expecter) Create(ctx interface{}, acct interface{}) *MockStorer_Create_Call {
	return &MockStorer_Create_Call{Call: _e.mock.On("Create", ctx, acct)}
}

func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, acct Account)) *MockStorer_Create_Call {
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, acct Account) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function for the type MockStorer
func (_mock *MockStorer) Delete(ctx context.Context, acct Account) error {
	ret := _mock.Called(ctx, acct)
...
//   - ctx context.Context
//   - acct Account
func (_e *MockStorer_Expecter) Delete(ctx interface{}, acct interface{}) *MockStorer_Delete_Call {
	return &MockStorer_Delete_Call{Call: _e.mock.On("Delete", ctx, acct)}
}

func (_c *MockStorer_Delete_Call) Run(run func(ctx context.Context, acct Account)) *MockStorer_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Delete_Call) RunAndReturn(run func(ctx context.Context, acct Account) error) *MockStorer_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Account, error) {
	...
	var r0 []Account
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) ([]Account, error)); ok {
		return returnFunc(ctx, filter, orderBy, cur)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) []Account); ok {
...
func (_c *MockStorer_Query_Call) Return(accounts []Account, err error) *MockStorer_Query_Call {
	_c.Call.Return(accounts, err)
	return _c
}

func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Account, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryByID provides a mock function for the type MockStorer
func (_mock *MockStorer) QueryByID(ctx context.Context, accountID uuid.UUID) (Account, error) {
...
func (_c *MockStorer_QueryByID_Call) Return(account Account, err error) *MockStorer_QueryByID_Call {
	_c.Call.Return(account, err)
	return _c
}

func (_c *MockStorer_QueryByID_Call) RunAndReturn(run func(ctx context.Context, accountID uuid.UUID) (Account, error)) *MockStorer_QueryByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockStorer
func (_mock *MockStorer) Update(ctx context.Context, acct Account) error {
	ret := _mock.Called(ctx, acct)
...
//   - ctx context.Context
//   - acct Account
func (_e *MockStorer_Expecter) Update(ctx interface{}, acct interface{}) *MockStorer_Update_Call {
	return &MockStorer_Update_Call{Call: _e.mock.On("Update", ctx, acct)}
}

func (_c *MockStorer_Update_Call) Run(run func(ctx context.Context, acct Account)) *MockStorer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Update_Call) RunAndReturn(run func(ctx context.Context, acct Account) error) *MockStorer_Update_Call {
	_c.Call.Return(run)
	return _c
}
