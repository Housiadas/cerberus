...
func (_mock *MockStorer) Create(ctx context.Context, o Outbox) error {
...
func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, o Outbox)) *MockStorer_Create_Call {
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, o Outbox) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockStorer_QueryUnprocessed_Call) Return(outboxs []Outbox, err error) *MockStorer_QueryUnprocessed_Call {
