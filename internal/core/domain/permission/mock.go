...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, page1 page.Page) ([]Permission, error) {
	...
	var r0 []Permission
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, page.Page) ([]Permission, error)); ok {
		return returnFunc(ctx, filter, orderBy, page1)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, page.Page) []Permission); ok {
...
func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, page1 page.Page) ([]Permission, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}
