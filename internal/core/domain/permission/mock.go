...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, page web.Page) ([]Permission, error) {
	...
	var r0 []Permission
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, web.Page) ([]Permission, error)); ok {
		return returnFunc(ctx, filter, orderBy, page)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, web.Page) []Permission); ok {
...
func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, page web.Page) ([]Permission, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}
