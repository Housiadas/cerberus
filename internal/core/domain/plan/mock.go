...
func (_mock *MockStorer) Create(ctx context.Context, pl Plan) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, Plan) error); ok {
...
//   - ctx context.Context
//   - pl Plan
func (_e *MockStorer_Expecter) Create(ctx interface{}, pl interface{}) *MockStorer_Create_Call {
	return &MockStorer_Create_Call{Call: _e.mock.On("Create", ctx, pl)}
}

func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, pl Plan)) *MockStorer_Create_Call {
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, pl Plan) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function for the type MockStorer
func (_mock *MockStorer) Delete(ctx context.Context, pl Plan) error {
	ret := _mock.Called(ctx, pl)
...
//   - ctx context.Context
//   - pl Plan
func (_e *MockStorer_Expecter) Delete(ctx interface{}, pl interface{}) *MockStorer_Delete_Call {
	return &MockStorer_Delete_Call{Call: _e.mock.On("Delete", ctx, pl)}
}

func (_c *MockStorer_Delete_Call) Run(run func(ctx context.Context, pl Plan)) *MockStorer_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Delete_Call) RunAndReturn(run func(ctx context.Context, pl Plan) error) *MockStorer_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Plan, error) {
	...
	var r0 []Plan
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) ([]Plan, error)); ok {
		return returnFunc(ctx, filter, orderBy, cur)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) []Plan); ok {
...
func (_c *MockStorer_Query_Call) Return(plans []Plan, err error) *MockStorer_Query_Call {
	_c.Call.Return(plans, err)
	return _c
}

func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Plan, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryByID provides a mock function for the type MockStorer
func (_mock *MockStorer) QueryByID(ctx context.Context, planID uuid.UUID) (Plan, error) {
	...
	var r0 Plan
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (Plan, error)); ok {
		return returnFunc(ctx, planID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) Plan); ok {
...
//   - ctx context.Context
//   - planID uuid.UUID
func (_e *MockStorer_Expecter) QueryByID(ctx interface{}, planID interface{}) *MockStorer_QueryByID_Call {
	return &MockStorer_QueryByID_Call{Call: _e.mock.On("QueryByID", ctx, planID)}
}

func (_c *MockStorer_QueryByID_Call) Run(run func(ctx context.Context, planID uuid.UUID)) *MockStorer_QueryByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_QueryByID_Call) Return(plan Plan, err error) *MockStorer_QueryByID_Call {
	_c.Call.Return(plan, err)
	return _c
}

func (_c *MockStorer_QueryByID_Call) RunAndReturn(run func(ctx context.Context, planID uuid.UUID) (Plan, error)) *MockStorer_QueryByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockStorer
func (_mock *MockStorer) Update(ctx context.Context, pl Plan) error {
	ret := _mock.Called(ctx, pl)
...
//   - ctx context.Context
//   - pl Plan
func (_e *MockStorer_Expecter) Update(ctx interface{}, pl interface{}) *MockStorer_Update_Call {
	return &MockStorer_Update_Call{Call: _e.mock.On("Update", ctx, pl)}
}

func (_c *MockStorer_Update_Call) Run(run func(ctx context.Context, pl Plan)) *MockStorer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Update_Call) RunAndReturn(run func(ctx context.Context, pl Plan) error) *MockStorer_Update_Call {
	_c.Call.Return(run)
	return _c
}
