...
func (_mock *MockStorer) Create(ctx context.Context, role Role) error {
...
//   - ctx context.Context
//   - role Role
func (_e *MockStorer_Expecter) Create(ctx interface{}, role interface{}) *MockStorer_Create_Call {
	return &MockStorer_Create_Call{Call: _e.mock.On("Create", ctx, role)}
}

func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, role Role)) *MockStorer_Create_Call {
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, role Role) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function for the type MockStorer
func (_mock *MockStorer) Delete(ctx context.Context, role Role) error {
	ret := _mock.Called(ctx, role)
...
//   - ctx context.Context
//   - role Role
func (_e *MockStorer_Expecter) Delete(ctx interface{}, role interface{}) *MockStorer_Delete_Call {
	return &MockStorer_Delete_Call{Call: _e.mock.On("Delete", ctx, role)}
}

func (_c *MockStorer_Delete_Call) Run(run func(ctx context.Context, role Role)) *MockStorer_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Delete_Call) RunAndReturn(run func(ctx context.Context, role Role) error) *MockStorer_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Role, error) {
	...
	var r0 []Role
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) ([]Role, error)); ok {
		return returnFunc(ctx, filter, orderBy, cur)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) []Role); ok {
...
func (_c *MockStorer_Query_Call) Return(roles []Role, err error) *MockStorer_Query_Call {
	_c.Call.Return(roles, err)
	return _c
}

func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Role, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryByID provides a mock function for the type MockStorer
func (_mock *MockStorer) QueryByID(ctx context.Context, userID uuid.UUID) (Role, error) {
	...
	var r0 Role
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) (Role, error)); ok {
		return returnFunc(ctx, userID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID) Role); ok {
...
func (_c *MockStorer_QueryByID_Call) Return(role Role, err error) *MockStorer_QueryByID_Call {
	_c.Call.Return(role, err)
	return _c
}

func (_c *MockStorer_QueryByID_Call) RunAndReturn(run func(ctx context.Context, userID uuid.UUID) (Role, error)) *MockStorer_QueryByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockStorer
func (_mock *MockStorer) Update(ctx context.Context, role Role) error {
	ret := _mock.Called(ctx, role)
...
//   - ctx context.Context
//   - role Role
func (_e *MockStorer_Expecter) Update(ctx interface{}, role interface{}) *MockStorer_Update_Call {
	return &MockStorer_Update_Call{Call: _e.mock.On("Update", ctx, role)}
}

func (_c *MockStorer_Update_Call) Run(run func(ctx context.Context, role Role)) *MockStorer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Update_Call) RunAndReturn(run func(ctx context.Context, role Role) error) *MockStorer_Update_Call {
	_c.Call.Return(run)
	return _c
}
