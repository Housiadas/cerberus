...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, page1 page.Page) ([]Role, error) {
	...
	var r0 []Role
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, page.Page) ([]Role, error)); ok {
		return returnFunc(ctx, filter, orderBy, page1)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, page.Page) []Role); ok {
...
func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, page1 page.Page) ([]Role, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}
