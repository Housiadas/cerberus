...
func insertSeedData(service *role_service.Service) (unitest.SeedData, error) {
	ctx := context.Background()

	roles, err := role_service.TestSeedRoles(ctx, 2, service)
	if err != nil {
...
func queryRole(service *role_service.Service, sd unitest.SeedData) []unitest.Table {
...
func createRole(service *role_service.Service) []unitest.Table {
	return []unitest.Table{
		{
			Name: "basic",
			ExpResp: role.New(
...
func updateRole(service *role_service.Service, sd unitest.SeedData) []unitest.Table {
...
func deleteRole(service *role_service.Service, sd unitest.SeedData) []unitest.Table {
	return []unitest.Table{
		{
			Name:    "role",
			ExpResp: nil,
