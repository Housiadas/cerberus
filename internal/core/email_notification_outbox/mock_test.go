...
func (_mock *MockStorer) Create(ctx context.Context, e email_notification_outbox.EmailNotificationOutbox) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, email_notification_outbox.EmailNotificationOutbox) error); ok {
		r0 = returnFunc(ctx, e)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, e email_notification_outbox.EmailNotificationOutbox)) *MockStorer_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 email_notification_outbox.EmailNotificationOutbox
		if args[1] != nil {
			arg1 = args[1].(email_notification_outbox.EmailNotificationOutbox)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, e email_notification_outbox.EmailNotificationOutbox) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockStorer) NewWithTx(tx pgsql.CommitRollbacker) (email_notification_outbox.Storer, error) {
	ret := _mock.Called(tx)
	...
	var r0 email_notification_outbox.Storer
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) (email_notification_outbox.Storer, error)); ok {
		return returnFunc(tx)
	}
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) email_notification_outbox.Storer); ok {
		r0 = returnFunc(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(email_notification_outbox.Storer)
		}
	}
...
func (_c *MockStorer_NewWithTx_Call) Return(storer email_notification_outbox.Storer, err error) *MockStorer_NewWithTx_Call {
	_c.Call.Return(storer, err)
	return _c
}

func (_c *MockStorer_NewWithTx_Call) RunAndReturn(run func(tx pgsql.CommitRollbacker) (email_notification_outbox.Storer, error)) *MockStorer_NewWithTx_Call {
	_c.Call.Return(run)
	return _c
}

// QueryUnprocessed provides a mock function for the type MockStorer
func (_mock *MockStorer) QueryUnprocessed(ctx context.Context, limit int, maxRetries int) ([]email_notification_outbox.EmailNotificationOutbox, error) {
	...
	var r0 []email_notification_outbox.EmailNotificationOutbox
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int) ([]email_notification_outbox.EmailNotificationOutbox, error)); ok {
		return returnFunc(ctx, limit, maxRetries)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int) []email_notification_outbox.EmailNotificationOutbox); ok {
		r0 = returnFunc(ctx, limit, maxRetries)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]email_notification_outbox.EmailNotificationOutbox)
		}
	}
...
func (_c *MockStorer_QueryUnprocessed_Call) Return(emailNotificationOutboxs []email_notification_outbox.EmailNotificationOutbox, err error) *MockStorer_QueryUnprocessed_Call {
	_c.Call.Return(emailNotificationOutboxs, err)
	return _c
}

func (_c *MockStorer_QueryUnprocessed_Call) RunAndReturn(run func(ctx context.Context, limit int, maxRetries int) ([]email_notification_outbox.EmailNotificationOutbox, error)) *MockStorer_QueryUnprocessed_Call {
	_c.Call.Return(run)
	return _c
}
