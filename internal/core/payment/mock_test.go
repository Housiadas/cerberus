...
func (_mock *MockStorer) NewWithTx(tx pgsql.CommitRollbacker) (payment.Storer, error) {
	ret := _mock.Called(tx)
	...
	var r0 payment.Storer
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) (payment.Storer, error)); ok {
		return returnFunc(tx)
	}
	if returnFunc, ok := ret.Get(0).(func(pgsql.CommitRollbacker) payment.Storer); ok {
		r0 = returnFunc(tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(payment.Storer)
		}
	}
...
func (_c *MockStorer_NewWithTx_Call) Return(storer payment.Storer, err error) *MockStorer_NewWithTx_Call {
	_c.Call.Return(storer, err)
	return _c
}

func (_c *MockStorer_NewWithTx_Call) RunAndReturn(run func(tx pgsql.CommitRollbacker) (payment.Storer, error)) *MockStorer_NewWithTx_Call {
	_c.Call.Return(run)
	return _c
}
