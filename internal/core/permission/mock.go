...
func (_mock *MockStorer) Create(ctx context.Context, p Permission) error {
...
func (_c *MockStorer_Create_Call) Run(run func(ctx context.Context, p Permission)) *MockStorer_Create_Call {
...
func (_c *MockStorer_Create_Call) RunAndReturn(run func(ctx context.Context, p Permission) error) *MockStorer_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Delete provides a mock function for the type MockStorer
func (_mock *MockStorer) Delete(ctx context.Context, p Permission) error {
	ret := _mock.Called(ctx, p)
...
func (_c *MockStorer_Delete_Call) Run(run func(ctx context.Context, p Permission)) *MockStorer_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Delete_Call) RunAndReturn(run func(ctx context.Context, p Permission) error) *MockStorer_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockStorer) Query(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Permission, error) {
	...
	var r0 []Permission
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) ([]Permission, error)); ok {
		return returnFunc(ctx, filter, orderBy, cur)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, QueryFilter, order.By, cursor.Cursor) []Permission); ok {
...
func (_c *MockStorer_Query_Call) Return(permissions []Permission, err error) *MockStorer_Query_Call {
	_c.Call.Return(permissions, err)
	return _c
}

func (_c *MockStorer_Query_Call) RunAndReturn(run func(ctx context.Context, filter QueryFilter, orderBy order.By, cur cursor.Cursor) ([]Permission, error)) *MockStorer_Query_Call {
	_c.Call.Return(run)
	return _c
}

// QueryByID provides a mock function for the type MockStorer
func (_mock *MockStorer) QueryByID(ctx context.Context, permissionID uuid.UUID) (Permission, error) {
...
func (_c *MockStorer_QueryByID_Call) Return(permission Permission, err error) *MockStorer_QueryByID_Call {
	_c.Call.Return(permission, err)
	return _c
}

func (_c *MockStorer_QueryByID_Call) RunAndReturn(run func(ctx context.Context, permissionID uuid.UUID) (Permission, error)) *MockStorer_QueryByID_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockStorer
func (_mock *MockStorer) Update(ctx context.Context, p Permission) error {
	ret := _mock.Called(ctx, p)
...
func (_c *MockStorer_Update_Call) Run(run func(ctx context.Context, p Permission)) *MockStorer_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStorer_Update_Call) RunAndReturn(run func(ctx context.Context, p Permission) error) *MockStorer_Update_Call {
	_c.Call.Return(run)
	return _c
}
