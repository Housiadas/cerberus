...
import (
	...
	refresh_token2 "github.com/Housiadas/cerberus/internal/core/refresh_token"
...
func TestService_Create_Successful(t *testing.T) {
	...
	mStorer := refresh_token2.NewMockStorer(t)
...
func TestService_QueryByToken_Successful(t *testing.T) {
	...
	expectedToken := refresh_token2.New(
...
func TestService_QueryByToken_Error(t *testing.T) {
	...
	mStorer := refresh_token2.NewMockStorer(t)
	mStorer.EXPECT().QueryByToken(ctx, token).Return(refresh_token2.RefreshToken{}, errors.New("not found"))
