...
import (
	...
	refund2 "github.com/Housiadas/cerberus/internal/core/refund"
...
type Service struct {
	log    logger.Logger
	storer refund2.Storer
}

// New constructs the service.
func New(log logger.Logger, storer refund2.Storer) *Service {
	return &Service{
		log:    log,
		storer: storer,
	}
...
func (s *Service) Create(ctx context.Context, ref refund2.Refund) error {
