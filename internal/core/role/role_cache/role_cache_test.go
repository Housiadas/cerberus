...
import (
	...
	rolemocks "github.com/Housiadas/cerberus/internal/core/role/mocks"
...
func newTestStore(t *testing.T) (*role_cache.Store, *rolemocks.MockStorer, *mockredisClient) {
	t.Helper()

	mockStorer := rolemocks.NewMockStorer(t)
