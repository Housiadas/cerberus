...
func TestService_Query_Successful(t *testing.T) {
	...
	expected := []user_roles_permissions2.UserRolesPermissions{
		user_roles_permissions2.New(
	...
	mStorer := user_roles_permissions2.NewMockStorer(t)
...
func TestService_QueryPermissionsByUserID_Successful(t *testing.T) {
	...
	expected := []user_roles_permissions2.Permission{
...
func TestService_QueryPermissionsByUserID_Empty(t *testing.T) {
	...
	mStorer := user_roles_permissions2.NewMockStorer(t)
	mStorer.EXPECT().QueryPermissionsByUserID(ctx, userID).Return([]user_roles_permissions2.Permission{}, nil)
