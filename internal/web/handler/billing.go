...
func (h *Handler) CreateCheckoutSession(
	...
	return openapi.CreateCheckoutSession200JSONResponse(
		toOpenAPICheckoutResponse(billing.CheckoutResponse{}),
	), nil
}
...
func (h *Handler) CreatePortalSession(
	...
	return openapi.CreatePortalSession200JSONResponse(
		toOpenAPIPortalResponse(billing.PortalResponse{}),
	), nil
}
