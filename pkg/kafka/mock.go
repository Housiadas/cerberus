...
// newMockoffsetStorer creates a new instance of mockoffsetStorer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockoffsetStorer(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockoffsetStorer {
	mock := &mockoffsetStorer{}
	mock.Mock.Test(t)
...
// mockoffsetStorer is an autogenerated mock type for the offsetStorer type
type mockoffsetStorer struct {
	mock.Mock
}

type mockoffsetStorer_Expecter struct {
	mock *mock.Mock
}

func (_m *mockoffsetStorer) EXPECT() *mockoffsetStorer_Expecter {
	return &mockoffsetStorer_Expecter{mock: &_m.Mock}
}

// StoreMessage provides a mock function for the type mockoffsetStorer
func (_mock *mockoffsetStorer) StoreMessage(m *kafka.Message) ([]kafka.TopicPartition, error) {
	ret := _mock.Called(m)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(*kafka.Message) ([]kafka.TopicPartition, error)); ok {
		return returnFunc(m)
	}
	if returnFunc, ok := ret.Get(0).(func(*kafka.Message) []kafka.TopicPartition); ok {
		r0 = returnFunc(m)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(*kafka.Message) error); ok {
		r1 = returnFunc(m)
	} else {
		r1 = ret.Error(1)
	}
...
// mockoffsetStorer_StoreMessage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StoreMessage'
type mockoffsetStorer_StoreMessage_Call struct {
	*mock.Call
}

// StoreMessage is a helper method to define mock.On call
//   - m *kafka.Message
func (_e *mockoffsetStorer_Expecter) StoreMessage(m interface{}) *mockoffsetStorer_StoreMessage_Call {
	return &mockoffsetStorer_StoreMessage_Call{Call: _e.mock.On("StoreMessage", m)}
}

func (_c *mockoffsetStorer_StoreMessage_Call) Run(run func(m *kafka.Message)) *mockoffsetStorer_StoreMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *kafka.Message
		if args[0] != nil {
			arg0 = args[0].(*kafka.Message)
		}
		run(
			arg0,
		)
...
func (_c *mockoffsetStorer_StoreMessage_Call) Return(topicPartitions []kafka.TopicPartition, err error) *mockoffsetStorer_StoreMessage_Call {
	_c.Call.Return(topicPartitions, err)
	return _c
}

func (_c *mockoffsetStorer_StoreMessage_Call) RunAndReturn(run func(m *kafka.Message) ([]kafka.TopicPartition, error)) *mockoffsetStorer_StoreMessage_Call {
	_c.Call.Return(run)
	return _c
}
